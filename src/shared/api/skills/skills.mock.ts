...
const DEFAULT_SKILL_LEVEL = BALANCE.skills.defaultLevel;
const DEFAULT_SKILL_MAX_LEVEL = BALANCE.skills.defaultMaxLevel;
const DEFAULT_SKILL_COST_PER_LEVEL = BALANCE.skills.upgradeCostPerLevel;
